...
pub fn parse_single(input: &[u8]) -> IResult<&[u8], ParsedBlock<'_>> {
    ...
    for index in 0..num_columns {
        ...
        // CH allows duplicate column names, but only procedural parsing can work with it and
        // derive will silently take the first column.
        // TODO: index access / mention it docs / whatever
